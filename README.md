...
[`examples/`](examples/) has twelve of them — chat, streaming, a coding agent,
durable sessions, delegation, writing your own tools, plugins, MCP in both
directions, mid-run steering, skills and project context, a test file showing
how to test the agent code *you* write, and [`cleaner`](examples/cleaner), an
autonomous GitHub issue fixer that is a whole application rather than a
demonstration. Five need no API key. [`examples/README.md`](examples/README.md)
