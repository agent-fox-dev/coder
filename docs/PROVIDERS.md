...
|---|---|---|---|---|---|---|
| `anthropic-messages` | `anthropic-version: 2023-06-01` | `POST https://api.anthropic.com/v1/messages` | none — hand-authored fixtures | — | 2026-09-06 | full; server-side compaction (REQ-PROV-07) is opt-in by beta header only, per OQ-4 |
